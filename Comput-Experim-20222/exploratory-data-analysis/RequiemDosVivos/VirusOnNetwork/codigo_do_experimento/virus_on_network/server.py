...
def network_portrayal(G):
    ...
    def node_color(agent):
        return {State.INFECTED: "#FF0000", State.SUSCEPTIBLE: "#008000", State.WATCHDOG: "#0047AB", State.DORMENT: "#FF8A8A"}.get(
            agent.state, "#808080"
        )
...
chart = mesa.visualization.ChartModule(
    [
        ...
        {"Label": "Watchdog", "Color": "#0047AB"},
        {"Label": "Dorment", "Color": "#FF8A8A"},
    ]
)
...
model_params = {
    ...
    "initial_watchdog_size": mesa.visualization.Slider(
        "Initial Watchdog Size",
        1,
        1,
        10,
        1,
        description="Watchs system health",
    ),
