...
class VirusOnNetwork(mesa.Model):
    ...
    def __init__(
        ...
        # a condição de estabilidade é que não haja mais nenhum agente com estado de Infected
        self.stable = 0 # se a variável for 1 significa que o modelo está estável
