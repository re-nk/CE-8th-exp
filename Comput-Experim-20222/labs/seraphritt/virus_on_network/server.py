...
def get_resistant_susceptible_ratio(model):
    ...
    stable_text = str(True if model.stable == 1 else False)

    return "Resistant/Susceptible Ratio: {}<br>Infected Remaining: {}<br> Stable: {}".format(
        ratio_text, infected_text, stable_text
    )
