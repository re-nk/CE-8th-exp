...
class SchellingAgentPolarized(mesa.Agent):
    ...
    def step(self):
        ...
        if similar < self.model.homophily:
            ...
            self.happy = True
            self.model.happy += 1
            #percentagem aproximada de agentes felizes/totais (0 casas decimais)
            self.model.happy_pctg = round(100 * self.model.happy/self.model.qty_agents ) #!percentagem de agentes felizes
...
class SchellingPolarized(mesa.Model):
    ...
    def __init__(self, width=20, height=20, density=0.8, minority_pc=0.2, homophily=3, polarization=30):
        ...
        self.datacollector = mesa.DataCollector(
            model_reporters={"stepCount":"stepCount", "happy": "happy",
                             "qty_agents":"qty_agents", "happy_pctg":"happy_pctg",
                             "qty_evictions":"qty_evictions"}  # Model-level count of happy agents
...
#                    print("qtd_expulsoes_totais==%d"%self.qtd_expulsoes_totais)
        ...
        if (self.happy_1 >= 0):
            ...
            #percentagem aproximada de agentes felizes/totais (0 casas decimais)
            self.happy_pctg = round(100 * self.happy/self.qty_agents ) 
