...
Este código apresenta uma modificação do modelo de segregfação de Schelling, onde foi introduzido o conceito de polarização política, 
que busca representar, entre 0 e 1, a chance de que um vizinho que está feliz "expulsar" os demais vizinhos que estão ao seu redor e que não são de sua mesma afinidade. Trata-se de simular um comportamento violento, pois em vez de se mudar, ele obriga o vizinho a fazer isso. 
