...
variaveis_independentes_e_seus_niveis = {
    ...
    "polarization": np.arange(0.0,1.1,0.2) #5x
}
...
qtd_maxima_passos_para_estabilizar = 1000 # qtd de interações necessárias para o fenômeno é estabilizar
...
model_name_preffix = "HAPPYPCTG.Exp.Tot.Cruzados_BetweenSubject_SchellingPolarizado"
